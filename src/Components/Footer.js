...
export default function Footer() {
  return (
    <div>
      <div className="card container-fluid container my-5" style={{background:'rgba(68, 68, 169, 0.6)',display:'flex',justifyContent:'center',alignItems:'center',color:'black', fontWeight:'bold' ,flex:'column'}}>
